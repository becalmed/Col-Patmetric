...
if __name__ == '__main__':
    img = Image.open('/home/fangjingwu/data/dataset/test_dataset/upper/paired_image/100001.jpg')
    image_mask_img, image_parse_img = run_human_tasks_grpc('172.16.0.17:8080', pil_b64(img), 'all')
